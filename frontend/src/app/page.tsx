...
import { Search, Plus, X, Users, Loader2, User, Briefcase } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
              ...
              Wesley High School Dashboard
            </h1>
            <p className="text-gray-500 mt-1">Manage student enrollments and records.</p>
          </div>
          
          <div className="flex items-center gap-3">
            <Link href="/teachers" className="flex items-center gap-2 bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 px-4 py-2.5 rounded-lg font-medium transition-all shadow-sm">
